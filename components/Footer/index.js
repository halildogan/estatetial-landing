        ...
        <div>
            ...
            <div className="footer__center center">
                ...
                <div className="footer__wrap">
                    ...
                    <img className="footer__pic footer__pic_dark" src="images/data/logo.svg" alt />
                    <img className="footer__pic footer__pic_light" src="images/data/logo.svg" alt />
                    </a>
                ...
                <div className="footer__line">
                    ...
                    <div className="footer__nav">
                        <a key={'home'} className="footer__link" href={`/#home`}>{'Home'}</a>
                        {list?.map((menu, index) => {
                            return (
                                <a key={index} className="footer__link" href={`/`+menu}>{capitalize(menu)}</a>
                            )
                        })}
                    </div>
                </div>
            ...
            <label className="switch js-switch-theme">
                ...
                <span className="switch__icon switch__icon_dark">
                    <svg className="icon icon-dark">
                    <use xlinkHref="#icon-dark" />
                    </svg>
                </span>
                <span className="switch__icon switch__icon_light">
