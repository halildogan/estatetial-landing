            ...
            <div className="review__container">
                <div className="review__slider owl-carousel js-slider-review">
                    <div className="review__item">
                        <div className="review__text">“ Solo makes life easier to me. With Solo you can organize your work and life in seconds. <br />5 stars!!! ” </div>
                    ...
                    <div className="review__item">
                        <div className="review__text">“ Solo makes life easier to me. With Solo you can organize your work and life in seconds. 5 stars!!! ”</div>
                        <div className="review__rating">
                        <div className="review__icon">
                            <img src="images/star-fill.svg" alt />
                        </div>
