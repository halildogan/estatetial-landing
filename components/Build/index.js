        ...
        <div className="history__center center">
            <div className="history__container">
                <div className="history__wrap">
                    <h2 className="history__title h2" data-aos="animation-scale-top" data-aos-duration={600}>Start building with Estatetial</h2>
                    <div className="history__info">Experiment with our Estatetial Demo Client and request play money from the Testnet Faucet. See how easy it is to build your own blockchain apps using our Estatetial SDK.</div>
                    <button className="history__btn btn btn_border">Go to Documentation</button>
                </div>
            </div>
